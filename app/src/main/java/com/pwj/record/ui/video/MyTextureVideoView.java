...
/**
 * @Author: pwj
 * @Date: 2020/12/15 19:38
 * @FileName: MyTextureVideoView
 * @Description: description
 */
public class MyTextureVideoView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public MyTextureVideoView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initVideoView() {
        try {
            ...
            mVolumn = manager.getStreamVolume(AudioManager.STREAM_MUSIC);
        } catch (Exception e) {
