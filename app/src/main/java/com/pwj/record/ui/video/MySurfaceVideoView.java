 ...
 * @FileName: MySurfaceVideoView
 * @Description: description
 */
public class MySurfaceVideoView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public MySurfaceVideoView(Context context, AttributeSet attrs, int defStyle) {
