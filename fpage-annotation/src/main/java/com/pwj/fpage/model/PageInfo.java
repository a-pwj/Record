package com.pwj.fpage.model;

import com.pwj.fpage.enums.CoreAnim;
import com.pwj.fpage.utils.GsonUtils;
...
public class PageInfo implements Serializable {
     ...
     * @param anim
     */
    public PageInfo(String name, String classPath, String params, CoreAnim anim, String extra) {
        this.name = name;
        this.classPath = classPath;
        this.params = params;
        this.anim = anim;
    ...
    public PageInfo setExtra(String extra) {
        this.extra = extra;
        return this;
    }
